<template>
	<view class="changePasswordContainer">
		<view class="changePasswordBox">
			<input type="" :value="oldPassword" placeholder="原密码" placeholder-class="co" />
			<input class="newPassword" type="text" :value="password" placeholder="新密码" placeholder-class="co" maxlength="20" @input="verifyPassword"/>
		</view>
