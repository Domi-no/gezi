<template>
	<view class="in_out_record_detailContainer">
		...
		<view class="in_out_record_detailOutBox">
			...
			<view class="">
				<text>生产批号</text><text>2020-12-21</text>
			</view>
		</view>
		<view class="in_out_record_detailOutBox">
			<view class="">
				<text>单位</text><text>2020-12-21</text>
			</view>
			<view class="">
				<text>数量</text><text>2020-12-21</text>
			</view>
			<view class="">
				<text>单价</text><text>2020-12-21</text>
			</view>
			<view class="">
				<text>合计金额</text><text>2020-12-21</text>
			</view>
		</view>
		<view class="in_out_record_detailOutBox">
			<view class="">
				<text>供货单位</text><text>2020-12-21</text>
			</view>
			<view class="">
				<text>批准人</text><text>2020-12-21</text>
			</view>
			<view class="">
				<text>接货人</text><text>2020-12-21</text>
			</view>
		</view>
		<view class="leaveReason">
			...
			<textarea   @input=""  placeholder="请输入备注" placeholder-style="font-size: 28rpx;font-weight: 500;color: #979797;" />
		</view>
	</view>
</template>
